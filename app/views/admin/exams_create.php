<div class="dashboard-view fade-in">
    <div class="view-header">
        ...
        <p>Pengaturan jadwal, mata pelajaran, dan durasi ujian.</p>
    </div>

    <div class="admin-recent-section glass-panel" style="max-width: 900px;">
        <form action="<?= url('admin/storeExam') ?>" method="POST" class="ajax-form">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group" style="grid-column: span 2;">
                    <label style="display: block; margin-bottom: 5px; color: var(--text-color); font-weight: 500;">Judul Ujian</label>
                    <input type="text" name="title" required class="form-control" style="width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.2); color: white; border-radius: 8px;" placeholder="Contoh: Penilaian Tengah Semester (PTS) Ganjil">
                </div>
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <select name="bundle_name" class="form-control" style="width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.2); background: #1f2937; color: white; border-radius: 8px;">
                        ...
                        <?php if(!empty($bundles)): foreach($bundles as $bundle): ?>
                            <option value="<?= e($bundle) ?>"><?= e($bundle) ?></option>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="duration_minutes" required min="1" class="form-control" style="width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.2); color: white; border-radius: 8px;" value="90">
                </div>

                <div class="form-group">
                    <label style="display: block; margin-bottom: 5px; color: var(--text-color); font-weight: 500;">KKM / Nilai Lulus</label>
                    <input type="number" name="passing_score" min="0" max="100" class="form-control" style="width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.2); color: white; border-radius: 8px;" value="75">
                </div>
                ...
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <select name="status" class="form-control" style="width: 100%; padding: 10px; border: 1px solid rgba(255,255,255,0.2); background: #1f2937; color: white; border-radius: 8px;">
                        <option value="draft">Draft (Belum bisa diakses siswa)</option>
                        <option value="published">Published (Tampil di dashboard siswa)</option>
                    </select>
                </div>
            </div>
