    ...
    <div class="admin-container">
        ...
        <aside class="admin-sidebar glass-panel">
            ...
            <nav class="sidebar-nav">
                ...
                <button class="nav-item <?= strpos($currentUri, 'teacher/dashboard') !== false ? 'active' : '' ?>" onclick="window.router.navigate('<?= url('teacher/dashboard') ?>')">
                    <i class="fas fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </button>

                <button class="nav-item <?= strpos($currentUri, 'teacher/exams') !== false ? 'active' : '' ?>" onclick="window.router.navigate('<?= url('teacher/exams') ?>')">
                    <i class="fas fa-book-open"></i>
                    <span>Manajemen Ujian</span>
                </button>

                <button class="nav-item <?= strpos($currentUri, 'teacher/questions') !== false ? 'active' : '' ?>" onclick="window.router.navigate('<?= url('teacher/questions') ?>')">
                    <i class="fas fa-database"></i>
                    <span>Bank Soal</span>
                </button>

                <button class="nav-item <?= strpos($currentUri, 'teacher/results') !== false ? 'active' : '' ?>" onclick="window.router.navigate('<?= url('teacher/results') ?>')">
            ...
            <div class="sidebar-footer">
                <div class="admin-profile" onclick="window.router.navigate('<?= url('teacher/dashboard') ?>')" style="cursor: pointer;" title="Buka Profil">
