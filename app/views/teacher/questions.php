<div class="dashboard-view fade-in">
    <div class="view-header flex-between" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <button class="btn-primary-admin" onclick="window.router.navigate('<?= url('teacher/create_question') ?>')">
                                ...
                                <td style="padding: 12px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                                    ...
                                    <?php if(!empty($q->question_image)): ?>
                                        <div style="margin-top: 8px;">
                                            <img src="<?= asset('uploads/questions/' . $q->question_image) ?>" alt="Gambar Soal" style="max-height: 80px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1);">
                                        </div>
                                    <?php endif; ?>
                                </td>
                                <td style="padding: 12px; border-bottom: 1px solid rgba(255,255,255,0.05);">
...
function deleteQuestion(id) {
    window.deleteItem('<?= url('teacher/deleteQuestion/') ?>' + id, 'Hapus Soal?');
}
</script>
