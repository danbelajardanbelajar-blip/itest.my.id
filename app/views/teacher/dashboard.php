<div class="dashboard-view fade-in">
    ...
    <div class="admin-recent-section glass-panel">
        <div class="section-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <button class="text-button" onclick="window.router.navigate('<?= url('teacher/exams') ?>')" style="background: none; border: none; color: #8b5cf6; cursor: pointer; font-weight: 500;">Lihat Semua</button>
        </div>
