<div class="dashboard-view fade-in">
    <div class="view-header flex-between" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div>
            ...
            <p>Kelola semua ujian, termasuk status dan jadwal ujian Anda.</p>
        </div>
        <button class="btn-primary-admin" onclick="window.router.navigate('<?= url('teacher/create_exam') ?>')">
...
function deleteExam(id) {
    window.deleteItem('<?= url('teacher/deleteExam/') ?>' + id, 'Hapus Ujian?');
}
</script>
