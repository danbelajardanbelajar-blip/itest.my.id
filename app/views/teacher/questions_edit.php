<div class="dashboard-view fade-in">
    <div class="view-header">
        <button class="btn-secondary-admin mb-3" onclick="window.router.navigate('<?= url('teacher/questions') ?>')">
    ...
    <div class="admin-recent-section glass-panel" style="max-width: 900px;">
        <form action="<?= url('teacher/updateQuestion/' . $question->id) ?>" method="POST" enctype="multipart/form-data" class="ajax-form">
